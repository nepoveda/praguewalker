    ...
    <section className="md:py-32 border-y bg-[#FBF9F6] border-[#EBE5DF] pt-16 pb-16 shadow-[inset_0_1px_0_0_#FFFFFF,inset_0_-1px_0_0_#FFFFFF]" id="usps">
      <div className="w-full max-w-360 mx-auto px-6">
        <div className="mb-12 md:mb-16">
          ...
          <div className="reveal-up w-20 sm:w-24 h-0.5 bg-linear-to-r from-[#E8501C] to-transparent mt-6 mb-8 md:mb-10 rounded-full"></div>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* USP 1 */}
          <div className="reveal-up bg-linear-to-br from-[#FFFFFF] via-[#FFFFFF] to-[#FFF1E6] hover:to-[#FFE4D6] p-6 md:p-8 rounded-3xl shadow-sm border border-[#F2EAE1] flex flex-col h-full group hover:-translate-y-2 hover:shadow-xl transition-all duration-300">
