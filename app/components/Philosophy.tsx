        ...
        <div className="w-full max-w-360 mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
            <div className="flex flex-col">
              ...
              <div
                  className="reveal-up w-20 sm:w-24 h-0.5 bg-linear-to-r from-[#E8501C] to-transparent mt-6 mb-8 sm:mb-10 rounded-full"></div>
              ...
              <div className="reveal-up grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 py-8">
                <div className="flex items-start text-left bg-gray-50/50 border border-gray-100 p-5 rounded-2xl gap-4">
                  <Icon icon="solar:clock-circle-linear" width="36" height="36"
                        className="text-[#E8501C] shrink-0 stroke-[1.5] mt-0.5"></Icon>
                  <div className="flex flex-col">
                    <h3 className="font-semibold text-sm uppercase tracking-wider text-[#0A0A0A] mb-1.5">Tailored
                      Pace</h3>
                ...
                <div className="flex items-start text-left bg-gray-50/50 border border-gray-100 p-5 rounded-2xl gap-4">
                  <Icon icon="solar:book-minimalistic-linear" width="36" height="36"
                        className="text-[#E8501C] shrink-0 stroke-[1.5] mt-0.5"></Icon>
                  <div className="flex flex-col">
                    <h3 className="font-semibold text-sm uppercase tracking-wider text-[#0A0A0A] mb-1.5">Academic
                      Insight</h3>
                    <p className="text-xs text-gray-600 font-normal">
