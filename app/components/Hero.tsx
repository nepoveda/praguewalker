...
const Hero = () => {
  return (
    <section className="relative h-[85vh] max-h-[900px] min-h-[600px] w-full flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 w-full h-full bg-[url('https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/6b3478ad-b1f0-4ef6-8994-db7941b8922c_3840w.jpg')] bg-cover bg-center">
        <img 
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-transparent to-[#0A0A0A]/90"></div>
      <div className="bg-gradient-to-tr from-[#0A0A0A]/50 via-transparent to-[#0A0A0A]/10 absolute top-0 right-0 bottom-0 left-0"></div>
      
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 text-center flex flex-col items-center">
        <div className="reveal-up inline-flex items-center justify-center px-4 py-2 sm:px-6 sm:py-2.5 rounded-full bg-black/40 border border-white/10 backdrop-blur-md shadow-2xl mb-6 sm:mb-8">
          <span className="uppercase text-[10px] sm:text-xs sm:tracking-[0.3em] font-light text-slate-50 tracking-[0.2em]">
        ...
        <div className="reveal-up flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mt-10 sm:mt-12 w-full sm:w-auto">
          <a href="#tours" className="w-full sm:w-auto h-14 px-8 sm:px-10 bg-[#E8501C] text-white text-sm font-semibold rounded-full flex items-center justify-center gap-2 hover:bg-[#c94315] transition-colors shadow-lg shadow-[#E8501C]/30 hover:shadow-[#E8501C]/50">
            View Our Signature Tours <iconify-icon icon="solar:arrow-right-linear" width="18"></iconify-icon>
          </a>
          <a href="#contact" className="sm:w-auto flex items-center justify-center gap-2 hover:bg-white/20 transition-all text-sm font-semibold text-white bg-white/10 w-full h-14 border-white/30 border rounded-full px-8 sm:px-10 backdrop-blur-md">
