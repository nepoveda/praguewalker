...
const Contact = () => {
    return (
        <section className="md:py-32 overflow-hidden bg-[#0A0A0A] pt-16 pb-16 relative" id="contact">
            ...
            <div
                className="absolute top-0 right-0 w-[400px] md:w-[800px] h-[400px] md:h-[800px] bg-[#6B1524]/20 rounded-full blur-[80px] md:blur-[120px] -translate-y-1/2 translate-x-1/3 pointer-events-none"></div>
            <div
                className="absolute bottom-0 left-0 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-[#E8501C]/10 rounded-full blur-[60px] md:blur-[100px] translate-y-1/3 -translate-x-1/3 pointer-events-none"></div>
            ...
            <div className="w-full max-w-[1440px] mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 md:gap-24 gap-x-12 gap-y-12 items-center">
                    ...
                    <div className="flex flex-col text-white relative z-10">
                        ...
                        <div className="reveal-up flex flex-col gap-4 md:gap-6">
                            <div className="flex items-center gap-4 group cursor-pointer">
                                <div
                                    className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#E8501C] group-hover:border-[#E8501C] transition-all">
                                    <iconify-icon icon="solar:letter-linear" width="20"
                                                  class="md:w-[24px] text-[#E8501C] group-hover:text-white transition-colors"></iconify-icon>
                                </div>
                                <div>
                                    <span
                            ...
                            <div className="flex items-center gap-4 group cursor-pointer">
                                <div
                                    className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#E8501C] group-hover:border-[#E8501C] transition-all">
                                    <iconify-icon icon="solar:phone-calling-linear" width="20"
                                                  class="md:w-[24px] text-[#E8501C] group-hover:text-white transition-colors"></iconify-icon>
                                </div>
                                <div>
                                    <span
                    ...
                    <div
                        className="reveal-up bg-white p-6 sm:p-8 md:p-10 rounded-3xl md:rounded-[2rem] shadow-2xl relative">
                        <div
                        ...
                        <form className="flex flex-col gap-4 md:gap-5" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <button type="submit"
                                ...
                                Book Your Private Tour <iconify-icon icon="solar:plain-2-linear"
