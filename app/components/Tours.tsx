      ...
      <section className="py-16 md:py-32 bg-[#FFFFFF]" id="tours">
        <div className="w-full max-w-360 mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Tour 1 */}
            <div
                className="reveal-up bg-[#FBF9F6] p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100 flex flex-col h-full group hover:-translate-y-2 hover:shadow-2xl transition-all duration-500">
              ...
              <h3 className="text-2xl font-semibold text-[#0A0A0A] tracking-tight mb-3 group-hover:text-[#E8501C] transition-colors">Prague
                at a Glance</h3>
            ...
            <div
              ...
              <div className="relative overflow-hidden rounded-2xl mb-6 w-full aspect-4/3">
                <div
                    className="z-10 text-[10px] md:text-xs uppercase font-semibold text-white tracking-widest bg-[#6B1524] rounded-full py-2 px-6 absolute top-4 right-4 shadow-md">Special
                  Offer
                </div>
                <Image
            ...
            <div
              ...
              <h3 className="text-2xl font-semibold text-[#0A0A0A] tracking-tight mb-3 group-hover:text-[#E8501C] transition-colors">Ten
          ...
          <div className="reveal-up mt-12 md:mt-16 flex justify-center w-full">
            <Link href="#tours"
               className="h-14 px-8 sm:px-10 border-2 border-[#E8501C] text-[#E8501C] bg-transparent text-sm font-semibold rounded-full flex items-center justify-center gap-2 hover:bg-[#E8501C] hover:text-white transition-all">
